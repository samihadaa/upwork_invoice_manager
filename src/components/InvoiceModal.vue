    ...
    <form @submit.prevent="submitForm" class="invoice-content">
        ...
        <div class="bill-form flex flex-column">
            ...
            <div class="input flex flex-column">
                <label for="billerStreetAdress">Street Adress</label>
                <input required type="text" id="billerStreetAdress" v-model="billerStreetAdress">
            </div>
        ...
        <div class="bill-to flex flex-column">
            ...
            <div class="input flex flex-column">
                <label for="clientStreetAdress">Street Adress</label>
                <input required type="text" id="clientStreetAdress" v-model="clientStreetAdress">
            </div>
            <div class="location-details flex">
                <div class="input flex flex-column">
        ...
        <div class="invoice-work flex flex-column">
            <div class="payment flex">
                ...
                <div class="input flex flex-column">
                    <label for="paymentDueDateUnix">Payment Due Date</label>
                    <input disabled required type="text" id="paymentDueDateUnix" v-model="paymentDueDateUnix">
                </div>
            </div>
            <div class="input flex flex-column">
            ...
            <div class="work-items">
                ...
                <table class="item-list">
                    ...
                    <tr class="table-items flex" v-for="(item,index) in invoiceItemList" :key="index">
                        ...
                        <td class="total flex">${{item.total = itesm.price * item.qty}}</td>
